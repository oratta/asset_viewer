...
$factory->define(UserAssetCategory::class, function (Faker $faker) {
    return [
        'asset_category_master_id' => function () {
...
$factory->afterCreating(App\UserAssetCategory::class, function ($userAssetCategory, $faker) {
        $userAssetList = factory(App\UserAsset::class,10)->create(["user_id"=>$userAssetCategory->user_id]);
        $userAssetCategory->userAssets()->saveMany($userAssetList);
